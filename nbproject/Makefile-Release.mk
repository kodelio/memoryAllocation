...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projet: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projet ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/Noyau_Start.o: Noyau_Start.asm
	${MKDIR} -p ${OBJECTDIR}
	$(AS) $(ASFLAGS) -o ${OBJECTDIR}/Noyau_Start.o Noyau_Start.asm
...
${OBJECTDIR}/keyboard.o: keyboard.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/keyboard.o keyboard.c
